...
export default function ContactModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const methods = [
    { id: 'wechat', label: t('contact.wechat'), value: 'EcoAPI-Service', color: '#07c160', copy: true, icon: <WeChatIcon /> },
    { id: 'whatsapp', label: 'WhatsApp', value: '+65 8123 4567', color: '#25d366', href: 'https://wa.me/6581234567', icon: <WhatsAppIcon /> },
    { id: 'telegram', label: 'Telegram', value: '@EcoAPI', color: '#229ed9', href: 'https://t.me/EcoAPI', icon: <TelegramIcon /> },
    { id: 'email', label: t('contact.email'), value: 'hello@ecoapi.ai', color: '#185fa5', href: 'mailto:hello@ecoapi.ai', icon: <MailIcon /> },
  ]
